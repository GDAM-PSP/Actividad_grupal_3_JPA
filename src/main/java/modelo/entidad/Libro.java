...
public class Libro {
	...
	// Relacion muchos a muchos apoyada con una tabla intermedia llamada
	// librerias_libro
	@ManyToMany(cascade = CascadeType.PERSIST)
	@JoinTable(name = "librerias_libro", joinColumns = {
			@JoinColumn(name = "fk_id_libro", referencedColumnName = "id") }, inverseJoinColumns = {
